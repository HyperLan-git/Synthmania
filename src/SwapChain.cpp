...
VkResult SwapChain::acquireNextImage(VkSemaphore waitFor, uint64_t timeout,
                                     VkFence fence, uint32_t *imageIndex) {
    return vkAcquireNextImageKHR(*device, swapChain, timeout, waitFor, fence,
                                 imageIndex);
}

VkResult SwapChain::isQueuePresent(VkQueue queue, VkSemaphore *semaphores,
